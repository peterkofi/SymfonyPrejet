 ...
 */
final class Version20220310042650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE planification (id INT AUTO_INCREMENT NOT NULL, programme_id INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_FFC02E1B62BB7AEE (programme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE planification ADD CONSTRAINT FK_FFC02E1B62BB7AEE FOREIGN KEY (programme_id) REFERENCES programme (id)');
    }
