 ...
 */
final class Version20220315173817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE unite_fonctionnelle_type_validation_uf (unite_fonctionnelle_id INT NOT NULL, type_validation_uf_id INT NOT NULL, INDEX IDX_E07BB1D8EBB88846 (unite_fonctionnelle_id), INDEX IDX_E07BB1D8CFD1A8FD (type_validation_uf_id), PRIMARY KEY(unite_fonctionnelle_id, type_validation_uf_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE unite_fonctionnelle_type_validation_uf ADD CONSTRAINT FK_E07BB1D8EBB88846 FOREIGN KEY (unite_fonctionnelle_id) REFERENCES unite_fonctionnelle (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE unite_fonctionnelle_type_validation_uf ADD CONSTRAINT FK_E07BB1D8CFD1A8FD FOREIGN KEY (type_validation_uf_id) REFERENCES type_validation_uf (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE unite_fonctionnelle_type_validation_uf');
