 ...
 */
final class Version20220310130611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_action ADD created_by_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sous_action ADD CONSTRAINT FK_97D37E65B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_97D37E65B03A8386 ON sous_action (created_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_action DROP FOREIGN KEY FK_97D37E65B03A8386');
        $this->addSql('DROP INDEX IDX_97D37E65B03A8386 ON sous_action');
        $this->addSql('ALTER TABLE sous_action DROP created_by_id, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
