 ...
 */
final class Version20220306205152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE province ADD created_by_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE province ADD CONSTRAINT FK_4ADAD40BB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_4ADAD40BB03A8386 ON province (created_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE province DROP FOREIGN KEY FK_4ADAD40BB03A8386');
        $this->addSql('DROP INDEX IDX_4ADAD40BB03A8386 ON province');
        $this->addSql('ALTER TABLE province DROP created_by_id, CHANGE libelle libelle VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
