 ...
 */
final class Version20220305071814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_566558962BB7AEE ON unite_fonctionnelle (programme_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_566558962BB7AEE ON unite_fonctionnelle');
