 ...
 */
final class Version20220316021159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure ADD created_by_id INT NOT NULL');
        $this->addSql('ALTER TABLE structure ADD CONSTRAINT FK_6F0137EAB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_6F0137EAB03A8386 ON structure (created_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6F0137EAB03A8386 ON structure');
        $this->addSql('ALTER TABLE structure DROP created_by_id, CHANGE type_de_structure type_de_structure VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
