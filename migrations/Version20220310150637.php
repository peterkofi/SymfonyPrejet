 ...
 */
final class Version20220310150637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_activite ADD created_by_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sous_activite ADD CONSTRAINT FK_B03B6140B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_B03B6140B03A8386 ON sous_activite (created_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_activite DROP FOREIGN KEY FK_B03B6140B03A8386');
        $this->addSql('DROP INDEX IDX_B03B6140B03A8386 ON sous_activite');
        $this->addSql('ALTER TABLE sous_activite DROP created_by_id, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE devise devise VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
