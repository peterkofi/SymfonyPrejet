 ...
 */
final class Version20220310123212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planification ADD created_by_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE planification ADD CONSTRAINT FK_FFC02E1BB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_FFC02E1BB03A8386 ON planification (created_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planification DROP FOREIGN KEY FK_FFC02E1BB03A8386');
        $this->addSql('DROP INDEX IDX_FFC02E1BB03A8386 ON planification');
        $this->addSql('ALTER TABLE planification DROP created_by_id, CHANGE description description VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
