 ...
 */
final class Version20220310151933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_activite ADD activite_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sous_activite ADD CONSTRAINT FK_B03B61409B0F88B1 FOREIGN KEY (activite_id) REFERENCES activite (id)');
        $this->addSql('CREATE INDEX IDX_B03B61409B0F88B1 ON sous_activite (activite_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_activite DROP FOREIGN KEY FK_B03B61409B0F88B1');
        $this->addSql('DROP INDEX IDX_B03B61409B0F88B1 ON sous_activite');
        $this->addSql('ALTER TABLE sous_activite DROP activite_id, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE devise devise VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
