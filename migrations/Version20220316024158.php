 ...
 */
final class Version20220316024158 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure DROP description, CHANGE type_de_structure type_de_structure VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
