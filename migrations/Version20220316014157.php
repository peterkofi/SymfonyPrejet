 ...
 */
final class Version20220316014157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure ADD structure_de_reference_id INT DEFAULT NULL, ADD categorie_id INT DEFAULT NULL, ADD type_de_structure VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE structure ADD CONSTRAINT FK_6F0137EA5B7B45C4 FOREIGN KEY (structure_de_reference_id) REFERENCES structure (id)');
        $this->addSql('ALTER TABLE structure ADD CONSTRAINT FK_6F0137EABCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id)');
        $this->addSql('CREATE INDEX IDX_6F0137EA5B7B45C4 ON structure (structure_de_reference_id)');
        $this->addSql('CREATE INDEX IDX_6F0137EABCF5E72D ON structure (categorie_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure DROP FOREIGN KEY FK_6F0137EA5B7B45C4');
        $this->addSql('ALTER TABLE structure DROP FOREIGN KEY FK_6F0137EABCF5E72D');
        $this->addSql('DROP INDEX IDX_6F0137EA5B7B45C4 ON structure');
        $this->addSql('DROP INDEX IDX_6F0137EABCF5E72D ON structure');
        $this->addSql('ALTER TABLE structure DROP structure_de_reference_id, DROP categorie_id, DROP type_de_structure');
