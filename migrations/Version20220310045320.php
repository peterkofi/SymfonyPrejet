 ...
 */
final class Version20220310045320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, sous_action_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_B8755515863B1B7A (sous_action_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE activite ADD CONSTRAINT FK_B8755515863B1B7A FOREIGN KEY (sous_action_id) REFERENCES sous_action (id)');
    }
